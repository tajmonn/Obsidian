...
List of games I wanna play. Just PC. Maybe should make one for 3DS...
Just single and coop games with story. Not all since I might not remember what I played. Also in finished are games that I actually finished. To the end. Abandoned ones might be added someday.
...
- [x] Left 4 Dead
- [x] Left 4 Dead 2
- [x] Lethal Company %% makes ppl sick %%
- [x] Paladins
- [x] Pico Park
- [x] Smite
- [x] Smite 2
- [x] Video Horror Society
- [x] Yes, Your Grace
- [x] BattleBlock Theater
- [x] Brawlhalla
- [x] Worms W.M.D
- [x] Golf with your friends
...
- [ ] Outer wilds (epic) %% time loop %%
- [ ] The outer worlds (epic) %% open world %% 
- [ ] Nine sols %% metroidvania %%
- [ ] Horizon: Forbidden west %% open world %%
- [ ] Dispatch %% story %%
- [ ] Echos of the end %% open world %%
- [ ] Citizen sleeper 2 %% RPG with dice (Disco Elysium?) %%
- [ ] Hell is us %% souls like %%
- [ ] 007 First Light %% 27/05/2026 %%
- [ ] Hogwarts Legacy %% maybe this time I'll finish it %%
- [ ] Baldur's Gate 3 %% abandoned in act 3 - waiting for sale for gf/friends %%

---
## COOP with GF To Play:

- [ ] Lego Voyagers %% story puzzles %%
- [ ] The past within %% escape room %%
- [ ] Pode %% story puzzles %%
- [ ] We Were Here Forever %% escape room %%
- [ ] We Were Here Too %% escape room %%
- [ ] Bokura: planet %% story puzzles %%
- [ ] Haunted paws %% not released %%
- [ ] Water Me & You %% not released (2026) %%
- [ ] Make me Float %% not released %%
- [ ] Hela %% not released %%
...
- [x] Portal Reloaded
- [x] Portal: Revolution
- [x] Portal Stories: Mel
- [x] Ruiner
- [x] Tormented souls
- [x] The Walking Dead: Telltale
- [x] A Way Out
- [ ] The Witcher 3: Wild Hunt
- [x] We Were Here Expeditions: The Friendship
- [x] We Were Here Together
- [x] Firewatch
- [x] Crossroad OS
- [x] Helltaker
...
- [x] Saints Row IV
- [x] Sherlock Holmes: The Devil's Daughter
- [x] That One Otter Game
- [x] Titanfall 2
- [x] Unravel Two
...
- [x] Deathloop
- [x] Orwell
- [x] Plague Tale: Innocence
- [x] Among the sleep
- [x] Alien: Isolation
- [x] Layers of fear
- [x] Hitman
- [x] Sherlock Holmes: crimes & punishment
- [x] Close to the Sun
- [x] Watch Dogs
...
- [x] Marvel's Spider-Man: Miles Morales
- [x] Frostpunk
...
- [ ] Pokemon Ultra Sun
- [x] Professor Layton and Miracle Mask
